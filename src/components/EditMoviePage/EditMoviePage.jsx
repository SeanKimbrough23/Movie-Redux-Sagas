          ...
          <div className="edit-content">
            <div className="edit-inputs">
              <TextField
                ...
                value={editedMovie ? editedMovie.title : movieDetails.title}
                id="outlined-basic"
                label="Title"
                variant="outlined"
              />
              <TextField
                ...
                value={editedMovie ? editedMovie.poster : movieDetails.poster}
                id="outlined-basic"
                label="Image"
                variant="outlined"
                sx={{ width: 400 }}
            ...
            <div className="right-content">
              ...
              <Button variant="contained" onClick={saveMovieChanges}>
                Save
              </Button>
            </div>
          </div>
